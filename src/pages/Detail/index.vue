    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImgList="skuImgList"/>
          <!-- 小图列表 -->
          <ImageList :skuImgList="skuImgList"/>
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)" changepirce="0" :class="{active:spuSaleAttrValue.isChecked ==1}" v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id">{{ spuSaleAttrValue.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
              ...
              <div class="add">
                <!-- 以前的路由跳转:从A路由跳转到B路由,这里再加入购物车,路由进行跳转之前,发送请求
