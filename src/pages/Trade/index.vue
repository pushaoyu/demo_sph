<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail" v-for="(order, index) in orderInfo.detailArrayList" :key="order.id">
        <h5>商品清单</h5>
        <ul class="list clearFix">
          <li>
            <img style="width: 100px;height: 100px;" :src="order.imgUrl" alt="">
          </li>
          <li>
            <p>{{ order.skuName }}</p>
            <h4>7天无理由退货</h4>
...
export default {
  ...
  computed: {
    ...
    ...mapState({ orderInfo: state => state.trade.orderInfo }),
  ...
  methods: {
    // 切换不同地址信息显示高亮
    changeAddress(address, addressInfo) {
